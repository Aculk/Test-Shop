...
<body>
    ...
    <div class="container main">
        ...
        <form action="/contact" method="post" class="form-control">
            ...
            <input type="text" name="age" placeholder="Введите возраст" value="<?= htmlspecialchars($_POST['age'] ?? '') ?>"> <br>
            <textarea name="message" placeholder="Введите само сообщение"><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
